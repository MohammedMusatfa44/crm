        ...
        @media (max-width: 991px) {            .modern-sidebar {                position: static;                min-width: 100%;                max-width: 100%;                border-radius: 0 0 1.2rem 1.2rem;                margin: 0 0 1.5rem 0;                height: auto;                flex-direction: row;                gap: 0.5rem;                padding: 1rem 0.5rem;            }            .main-content-fixed {
            ...
            <aside class="col-md-2 modern-sidebar d-flex flex-column h-100" style="margin:0;">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item"><a class="nav-link @if(request()->is('dashboard')) active @endif" href="/dashboard"><i class="bi bi-speedometer2"></i> لوحة التحكم</a></li>
                    <li class="nav-item"><a class="nav-link @if(request()->is('customers*')) active @endif" href="/customers"><i class="bi bi-people"></i> العملاء</a></li>
                    <li class="nav-item"><a class="nav-link @if(request()->is('users*')) active @endif" href="/users"><i class="bi bi-person-badge"></i> المستخدمون</a></li>
                    <li class="nav-item"><a class="nav-link @if(request()->is('departments*')) active @endif" href="/departments"><i class="bi bi-diagram-3"></i> الأقسام</a></li>
